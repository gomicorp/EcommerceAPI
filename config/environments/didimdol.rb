Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'didimdol-api.gomistore.com'
  config.hosts << 'didimdol-api.gomistore.com'
  ...
  config.force_ssl = ENV['RAILS_FORCE_SSL']
  ...
  Raven.configure do |config|
    config.dsn = ENV['SENTRY_DSN'] || Rails.application.credentials.dig(:sentry, Rails.env.to_sym, :dsn)
  end
